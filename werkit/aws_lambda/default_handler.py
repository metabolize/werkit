...
env_lambda_worker_timeout = int(os.environ[LAMBDA_WORKER_TIMEOUT]) if LAMBDA_WORKER_TIMEOUT in os.environ else None
...
def handler(event, context, lambda_worker_function_name=env_lambda_worker_function_name, timeout=env_lambda_worker_timeout or 120):
